...
14. **`supreme_court_case_study`**: Matches filenames containing landmark court cases or judgments (e.g. `hyatt-international`, `safari-retreats`, `gameskraft`, `rajeev-bansal`, `tola`, `vkc-footsteps`, `aberdare-technologies`, `b-braun-medical`, `blackstone-capital`, `ghanashyam-mishra`, `suncraft-energy`, `vidya-drolia`, `formula-one-vs-hyatt`, `yasho-industries`, `brij-systems`, `mrityunjay-kumar`, `nestle-mli`, `shree-sai-baba-trust`, `samsung-heavy-industries`, `engineering-analysis-centre`). These pages present court rulings in a 4-panel case study format (Dispute Details, Court Ratio, Key Evidence, and Action Points) and omit all HTML FAQs and JSON-LD FAQPage schemas.
