...
const manifestPath = path.join(root, 'batches37-downloaded-indexnow-urls.json');
const sourcePath = path.join(root, 'batches37-downloaded-source-slugs.json');
const ctaUrl = '/?signup=true&role=client';
const factDate = '2026-06-18';
const batchNumbers = [37];
