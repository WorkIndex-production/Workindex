...
const manifestPath = path.join(root, 'batch23-downloaded-indexnow-urls.json');
const sourcePath = path.join(root, 'batch23-downloaded-source-slugs.json');
const ctaUrl = '/?signup=true&role=client';
const factDate = '2026-06-14';
const batchNumbers = [23];
