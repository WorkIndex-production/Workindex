...
const manifestPath = path.join(root, 'batches25-30-downloaded-indexnow-urls.json');
const sourcePath = path.join(root, 'batches25-30-downloaded-source-slugs.json');
const ctaUrl = '/?signup=true&role=client';
const factDate = '2026-06-17';
const batchNumbers = [25, 26, 27, 28, 29, 30];
