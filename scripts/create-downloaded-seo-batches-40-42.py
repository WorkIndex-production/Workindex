...
manifest_path = root / "batches40-42-downloaded-indexnow-urls.json"
source_path = root / "batches40-42-downloaded-source-slugs.json"
cta_url = "/?signup=true&role=client"
fact_date = "2026-06-20"
batch_numbers = [40, 41, 42]
