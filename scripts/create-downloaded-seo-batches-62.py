...
manifest_path = root / "batches62-downloaded-indexnow-urls.json"
source_path = root / "batches62-downloaded-source-slugs.json"
progress_file = Path("C:/Ravish/indexer/progress.json")
urls_file = Path("C:/Ravish/indexer/urls.txt")

cta_url = "/?signup=true&role=client"
fact_date = "2026-06-26"
batch_numbers = [62]
...
# ==========================================
# COURT CASE STUDY TEMPLATES & MAPPING (IMPORTED)
# ==========================================
