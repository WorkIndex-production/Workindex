...
manifest_path = root / "batches68-71-downloaded-indexnow-urls.json"
source_path = root / "batches68-71-downloaded-source-slugs.json"
progress_file = Path("C:/Ravish/indexer/progress.json")
urls_file = Path("C:/Ravish/indexer/urls.txt")

cta_url = "/?signup=true&role=client"
fact_date = "2026-06-28"
batch_numbers = [68, 69, 70, 71]
...
def main():
    ...
    # 2. Extract pages from batch 68 to 71
    raw_pages = []
