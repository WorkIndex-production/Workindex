...
manifest_path = root / "batch72-downloaded-indexnow-urls.json"
source_path = root / "batch72-downloaded-source-slugs.json"
...
# ==========================================
# CATEGORIES & CLASSIFICATION (BATCH 72)
# ==========================================
...
def get_category_and_topic(slug, batch_num):
    ...
    if re.search(r'co-living|subletting|flatmate|oyo-franchise|oyo-partner|paying-guest|serviced-apartment|furnished-flat|co-working|virtual-office|shared-office|renting-garage|renting-terrace|renting-roof|renting-land|short-term-rental|long-term-lease|rent-free-accommodation|lease-renewal|hostel-rent|pg-accommodation|student-housing|airbnb-host|holiday-home|vacation-rental', slug_lower):
...
fact_check_bullets = {
    ...
    "digital_payments_upi": [
        ...
        "Payment gateways charge 18% GST on their processing fees, which B2B merchants can claim as input tax credit (ITC)."
    ],
    "saas_subscription": [
    ...
    "msme_compliance": [
        "Under Section 43B(h), payments due to registered MSMEs (Micro and Small) must be made within 15 days (or up to 45 days if per written agreement), or the buyer cannot claim tax deduction for that year.",
        "Delayed payments to MSMEs trigger compound interest at three times the RBI bank rate, which is a mandatory statutory liability and is not tax-deductible for the buyer.",
    ...
    "family_business": [
        ...
        "Loans given by family members to a business are not taxable as income, but they must be supported by loan agreements and bank transfers to prevent Section 68 additions.",
    ...
    "specific_jobs": [
        ...
        "Freelance journalists, actors, and stand-up comedians must register for GST if their annual professional services receipts exceed ₹20 lakh.",
