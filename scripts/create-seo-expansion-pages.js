...
const calculators = [
  ['income-tax-calculator', 'Income Tax Calculator India', 'taxable income', 'Shared WorkIndex income tax engine: slab tax, 87A rebate, surcharge, cess and credits', 'income'],
...
<section class="lp-section"><h2 class="lp-section-title">Working calculator</h2><p class="lp-section-sub">This page uses the shared WorkIndex calculator engine, with page-specific inputs, result output, source notes and a last fact-checked date.</p></section>
