...
const manifestPath = path.join(root, 'batches38-39-downloaded-indexnow-urls.json');
const sourcePath = path.join(root, 'batches38-39-downloaded-source-slugs.json');
const ctaUrl = '/?signup=true&role=client';
const factDate = '2026-06-19';
const batchNumbers = [38, 39];
