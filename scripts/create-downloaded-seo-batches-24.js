...
const manifestPath = path.join(root, 'batch24-downloaded-indexnow-urls.json');
const sourcePath = path.join(root, 'batch24-downloaded-source-slugs.json');
const ctaUrl = '/?signup=true&role=client';
const factDate = '2026-06-15';
const batchNumbers = [24];
